...
<main>
    ...
    <img class="distro_img" src="./assets/img/distribucie/mint.png" alt="linux-mint"></div>
    ...
    <img class="distro_img" src="./assets/img/distribucie/manjaro.jpeg" alt="manjaro"></div>
    ...
    <img class="distro_img" src="./assets/img/distribucie/fedora.jpg" alt="fedora"></div>
    ...
    <img class="distro_img" src="./assets/img/distribucie/debian.jpg" alt="debian"></div>
    ...
    <img class="distro_img" src="./assets/img/distribucie/opensuseleap.png" alt="opensuse-leap"></div>
</main>
